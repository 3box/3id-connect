...
class AbstractAuthProvider {
  ...
  /**
    ...
    * @param     {String}    id        unique id for authprovider
    * @param     {String}    name      display name for your authprovider
    * @param     {String}    image     your image/logo name available in assets export
    */
  constructor() {
    this.network = null
    this.id = null
  ...
  */
  ...
  /**
    *  (Optional) connect function will perform any setup needed for your authProviders
    *  Right now this is called right before authenticate. In the future it may called
    *  earlier to optimistically load providers. This shouldn require any user interaction.
    *
    * @return    {Boolean}                 Return true once connected
  */
  async connect() {
    return true
  }
  ...
  /**
    *  (Optional) disconnect function should perform any clean up state/connections
    *  made in connect.
    *
    * @return    {Boolean}   Return true once complete
  */
  async disconnect() {
    return true
  }
